 ...
 *
 */
public final class OmronStationaryBloodPressureSensor extends AbstractSensorType {
	
	public OmronStationaryBloodPressureSensor(String sensorID, String sensorMAC) {
		super(sensorID, sensorMAC);
		sensorType = BLOOD_PRESSURE_SENSOR;
		description = "Stationary Bluetooth-enabled blood pressure sensor from Omron.";
