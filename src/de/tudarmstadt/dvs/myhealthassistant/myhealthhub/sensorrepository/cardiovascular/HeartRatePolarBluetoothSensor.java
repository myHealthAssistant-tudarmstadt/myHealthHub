 ...
 *
 */
public final class HeartRatePolarBluetoothSensor extends AbstractSensorType  {

	/**
	 * 
	 */
	public HeartRatePolarBluetoothSensor(String sensorID, String sensorMAC) {
		super(sensorID, sensorMAC);
		sensorType = HEART_RATE_SENSOR;
		description = "Heart rate sensor manufactored by Polar";
