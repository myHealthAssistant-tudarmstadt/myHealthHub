 ...
 * 
 */
public class MagneticSensorEvent extends AccSensorEvent {

	public static String EVENT_TYPE = SensorReadingEvent.MAGNETIC_FIELD;
	 ...
	 *            Time of measurement.
	 */
	public MagneticSensorEvent(String eventID, String timestamp, String producerID,
	...
	public static final Parcelable.Creator<MagneticSensorEvent> CREATOR = new Parcelable.Creator<MagneticSensorEvent>() {

		@Override
		public MagneticSensorEvent createFromParcel(Parcel source) {
			return new MagneticSensorEvent(source);
		}

		@Override
		public MagneticSensorEvent[] newArray(int size) {
			return new MagneticSensorEvent[size];
		}
	};
	...
	private MagneticSensorEvent(final Parcel source) {
