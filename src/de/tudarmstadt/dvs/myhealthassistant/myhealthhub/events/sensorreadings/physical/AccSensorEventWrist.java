 ...
 * 
 */
public class AccSensorEventWrist extends AccPeakSensorEvent{

	public static String EVENT_TYPE = SensorReadingEvent.ACCELEROMETER_WRIST;
	 ...
	 *            Time of measurement.
	 */
	public AccSensorEventWrist(String eventID, String timestamp, String producerID,
	...
	public static final Parcelable.Creator<AccSensorEventWrist> CREATOR = new Parcelable.Creator<AccSensorEventWrist>() {

		@Override
		public AccSensorEventWrist createFromParcel(Parcel source) {
			return new AccSensorEventWrist(source);
		}

		@Override
		public AccSensorEventWrist[] newArray(int size) {
			return new AccSensorEventWrist[size];
		}
	};
	...
	private AccSensorEventWrist(final Parcel source) {
