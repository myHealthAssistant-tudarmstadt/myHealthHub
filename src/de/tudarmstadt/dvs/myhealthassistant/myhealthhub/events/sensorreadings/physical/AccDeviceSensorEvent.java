 ...
 * 
 */
public class AccDeviceSensorEvent extends SensorReadingEvent {

	public static String EVENT_TYPE = SensorReadingEvent.ACCELEROMETER_ON_DEVICE;
	 ...
	 *            Time of measurement.
	 */
	public AccDeviceSensorEvent(String eventID, String timestamp, String producerID,
	...
	public static final Parcelable.Creator<AccDeviceSensorEvent> CREATOR = new Parcelable.Creator<AccDeviceSensorEvent>() {

		@Override
		public AccDeviceSensorEvent createFromParcel(Parcel source) {
			return new AccDeviceSensorEvent(source);
		}

		@Override
		public AccDeviceSensorEvent[] newArray(int size) {
			return new AccDeviceSensorEvent[size];
		}
	};
	...
	private AccDeviceSensorEvent(final Parcel source) {
