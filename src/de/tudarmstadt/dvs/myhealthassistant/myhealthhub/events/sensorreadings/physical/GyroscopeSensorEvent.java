 ...
 * 
 */
public class GyroscopeSensorEvent extends AccSensorEvent {

	public static String EVENT_TYPE = SensorReadingEvent.GYROSCOPE;
	 ...
	 *            Time of measurement.
	 */
	public GyroscopeSensorEvent(String eventID, String timestamp, String producerID,
	...
	public static final Parcelable.Creator<GyroscopeSensorEvent> CREATOR = new Parcelable.Creator<GyroscopeSensorEvent>() {

		@Override
		public GyroscopeSensorEvent createFromParcel(Parcel source) {
			return new GyroscopeSensorEvent(source);
		}

		@Override
		public GyroscopeSensorEvent[] newArray(int size) {
			return new GyroscopeSensorEvent[size];
		}
	};
	...
	private GyroscopeSensorEvent(final Parcel source) {
