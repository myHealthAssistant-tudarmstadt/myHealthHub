...
public class WeightEventInKg extends WeightEvent {

	public static String EVENT_TYPE = SensorReadingEvent.WEIGHT_IN_KG;
	 ...
	 *            Time of measurement.
	 */
	public WeightEventInKg(String eventID, String timestamp, String producerID,
	...
	public static final Parcelable.Creator<WeightEventInKg> CREATOR = new Parcelable.Creator<WeightEventInKg>() {

		@Override
		public WeightEventInKg createFromParcel(Parcel source) {
			return new WeightEventInKg(source);
		}

		@Override
		public WeightEventInKg[] newArray(int size) {
			return new WeightEventInKg[size];
		}
	};
	...
	private WeightEventInKg(final Parcel source) {
